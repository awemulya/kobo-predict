...
class BarGenerator(object):
    ...
    def get_range(self, progress):
        ...
        if progress in range(40,50): return self.data.keys()[5]
        if progress in range(50,60): return self.data.keys()[6]
        if progress in range(60,70): return self.data.keys()[7]
        if progress in range(70,80): return self.data.keys()[8]
        if progress in range(80,90): return self.data.keys()[9]
        if progress in range(90,101): return self.data.keys()[10]
